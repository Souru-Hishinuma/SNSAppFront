...
export const Topbar = () => {
  return (
    <div class="bg-slate-500 h-14 w-full flex items-center sticky top-0 z-100">
        ...
        <div class="w-4/12 flex align-center justify-around text-white">
            <div class="flex">
                <div class="mr-4 cursor-pointer relative mt-1">
                    ...
                    <span class="absolute -top-1 -right-1 w-4 h-4 bg-purple-400 flex align-center justify-center rounded-full text-sm">1</span>
                </div>
                <div class="mr-4 cursor-pointer relative mt-1">
                    ...
                    <span class="absolute -top-1 -right-1 w-4 h-4 bg-purple-400 flex align-center justify-center rounded-full text-sm">2</span>
                </div>
